...
echo $red"harap sabar menunggu yaa Gan"
sleep 1
echo '''\a
\033[34;1m                              _
\033[34;1m                             / |
...
echo
echo
echo $red"Tools akan di install dalam waktu 4 detik"
echo $red"harap sabar menunggu yaa Gan"
sleep 1
echo '''\a
\033[32;1m                             ____
...
echo
echo
echo $red"Tools akan di install dalam waktu 3 detik"
echo $red"harap sabar menunggu yaa Gan"
sleep 1
echo '''\a
\033[35;1m                            _____
...
echo
echo
echo $red"Tools akan di install dalam waktu 2 detik"
echo $red"harap sabar menunggu yaa Gan"
sleep 1
echo '''\a
\033[33;1m                            _  _
...
echo
echo
echo $red"Tools akan di install dalam waktu 1 detik"
echo $red"harap sabar menunggu yaa Gan"
sleep 1
echo '''\a
\033[36;1m                             ____
...
sleep 2
echo $pur"Terima kasih Yang Sudah Support Dalam Pembuatan Tools Ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { Cyser Inc. }"
exit
fi
